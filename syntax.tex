...
The grammar specified in section 10.5 of the Haskell 2010 report \cite{Report:105} is a specification of the expanded syntax of Haskell.

As specified in section 2.7 \cite{Report:27}, the expanded syntax of Haskell specifies Haskell programs when written using semicolons and braces. However, these can be omitted in a real Haskell program. The compiler will then utilize layout rules for certain grammar structures instead. These are specified in section 10.3 \cite{Report:103}.
...
Section 10.1 \cite{Report:101} specifies the notation used in the grammar.
