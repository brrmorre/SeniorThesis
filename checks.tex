...
In the TopDecl sort, there are three type constructors that are used to create user defined datatypes. These are data, type, and newtype.
...
Also, The polymorphic parameters that appear on the left hand side of a $data$ declaration need to be unique.
