...
Much of the inference algorithm is the same as the one introduced in CS 421. \cite{CS421:Unif}
...
The following is a mathematical definition where $\theta$ and $\lambda$ are substitutions. \cite{Infer:Compose}
