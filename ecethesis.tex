\documentclass[draftthesis,mixcasechap,tocnosub,noragright,centerchapter,12pt]{uiucecethesis09}
...
xleftmargin=.4in}
%\lstset{framextopmargin=50pt,frame=bottomline,numbers=left}
...
%\begin{document}
%\othermasters[BS]{Bachelor of Science}

\title{Haskell Syntax and Static Semantics written in K-Framework}
\author{Bradley Morrell}
...
\begin{document}
\othermasters{Bachelor of Science}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% COPYRIGHT
%
%\copyrightpage
